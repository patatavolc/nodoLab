...
Se crean dos archivos chatHandlers.socket y manager.socket.js, manager.socket.js escucha en el puerto por si se conecta un suario, lo añada al mapa de usuarios conectados,
delega la comunicación al archivo chatHandlers.socket y borra del mapa de usuarios cuando este se desconecta.
...
Se añada la obtencion del token del usuario al iniciar sesion.
